...
def inpu():
    ...
    if turn<=8:
        if turn%2==0:
            co1= input("Player1! Enter your desired coordinate in this 'ab' form where a is row position and b is column position")
            ...
            co2= input("Player2! Enter your desired coordinate in this 'ab' form where a is row position and b is column position")
